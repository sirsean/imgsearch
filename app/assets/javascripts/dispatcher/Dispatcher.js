...
/**
 * _Dispatcher is used to broadcast payloads to registered callbacks. This is
 ...
 *
 *   var flight_Dispatcher = new _Dispatcher();
 *
 ...
 *
 *   flight_Dispatcher.register(function(payload) {
 ...
 *
 *    CountryStore.dispatchToken = flight_Dispatcher.register(function(payload) {
 ...
 *
 *   CityStore.dispatchToken = flight_Dispatcher.register(function(payload) {
 *     if (payload.actionType === 'country-update') {
 *       // `CountryStore.country` may not be updated.
 *       flight_Dispatcher.waitFor([CountryStore.dispatchToken]);
 ...
 *         case 'country-update':
 *         case 'city-update':
 *           flight_Dispatcher.waitFor([CityStore.dispatchToken]);
